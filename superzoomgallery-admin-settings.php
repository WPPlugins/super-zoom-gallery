...
<div class="wrap rsec-settings">
  ...
  <div style="position:absolute; bottom:0px;">
    <h3>Help a developer through the long cold dutch <?php echo current_season(); ?></h3>
    <p>If you like this plugin, please consider making a donation. It is much appreciated!</p>
    <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
      <input type="hidden" name="cmd" value="_s-xclick">
      <input type="hidden" name="hosted_button_id" value="ETZZD7NDFUGCJ">
